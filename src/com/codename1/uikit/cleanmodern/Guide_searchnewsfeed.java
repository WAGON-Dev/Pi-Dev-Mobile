...
import static com.codename1.uikit.cleanmodern.ProfilFormGuide.username;
 ...
 * @author Ghassen
 */
public class Guide_searchnewsfeed extends GuideBaseForm{
     public Guide_searchnewsfeed(Resources res) {
        ...
        Container Searchcont = new Container(flow);
        Label schl = new Label("Rechercher");
        TextField srch = new TextField("", "Nom");
        srch.setUIID("TextFieldBlack");
        Button chercher = new Button("Chercher");
        Component.setSameSize(radioContainer, spacer2);
        Searchcont.add(LayeredLayout.encloseIn(BorderLayout.south(
                BoxLayout.encloseY(schl, srch, chercher))));

        add(LayeredLayout.encloseIn(swipe, radioContainer));
        add(LayeredLayout.encloseIn(Searchcont));
        
        chercher.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                new Guide_vpsearch(res, srch.getText()).show();
            }
        });
...
//        con.setUrl("http://localhost/apijsonpi/web/app_dev.php/api/vp/randone"); //Pour la liste des étudiants 
