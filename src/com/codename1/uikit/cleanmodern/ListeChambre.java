...
import com.codename1.uikit.cleanmodern.UpdateChambre;
 ...
 * @author Ahmed
 */
public class ListeChambre extends BaseFormhotel {

    Container AfficheChambre;

    public ListeChambre(Resources res) {
        ...
        addTab(swipe, res.getImage("index2.jpg"), spacer1, "15 Likes  ", "85 Comments", "vos chambres ");
        ...
        con.setUrl("http://localhost:8081/Mobile1/web/app_dev.php/api/chambre/all/"+authuser.user.getId_user()); //Pour la liste des étudiants 
                    ...
                    for (Chambre t : getListChambre(new String(con.getResponseData()))) {
                        ...
                        btn.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent evt) {
                                ...
                                req.setUrl("http://localhost:8081/Mobile1/web/app_dev.php/api/?id=" + t.getIdChambre() + "/delete" + "");
                        ...
                        btn2.addActionListener(new ActionListener() {
                            @Override
                            public void actionPerformed(ActionEvent evt) {
                                 UpdateChambre upd = new UpdateChambre(res, t);
                                 upd.show();
                            }
                        });
