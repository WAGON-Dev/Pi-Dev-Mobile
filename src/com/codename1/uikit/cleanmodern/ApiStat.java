 ...
 * @author Ahmed
 */
public class ApiStat extends BaseFormClient{
     /**
 ...
 for (double value : values) {
    ...
    public Form createPieChartForm() {
        ...
        // Generate the values
        double[] values = new double[]{68, 30, 4, 20};

        // Set up the renderer
        int[] colors = new int[]{ColorUtil.BLACK, ColorUtil.GREEN, ColorUtil.BLUE, ColorUtil.YELLOW};
